...
gameSettings.maxPokemonPerRow = gameSettings.mobileOrNot ? Math.floor(gameSettings.maxNumberOfPokemon / 5) : Math.floor(gameSettings.maxNumberOfPokemon / 3); //// Changes when to separate the cards for evenness depending on if it's a mobile device or not
