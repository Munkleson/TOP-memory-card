...
function fiftyFiftyMixShuffle(arrayOfPokemon, maxNumberOfPokemon, clickedArray, fiftyFiftyMixRngCounter, setFiftyFiftyMixRngCounter, setFiftyFiftyMixBothFalse) {
    ...
    function shuffleFunction() {
        //// function used so I can utilise closures to make a pseudo-rng generator
        if (Math.floor(Math.random() * fiftyFiftyMixRngCounter) === 0 && clickedArray.length > 2) {
            //// For when it contains two cards that have been clicked before
