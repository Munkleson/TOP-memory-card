...
function FiftyFiftyGame({ cardClick, finalCard, gameResult, numberOfPokemon, currentlyFlipping, currentlyDisplayedCards, gameMode, maxNumberOfPokemonShown, cardsRemaining, cardsRemainingInitialValue }) {
