...
function EndingScreen({ gameResult, replayGame }){
    ...
    }, []); //// I believe a dependency array and effect is absolutely needed here, because if I don't have it, the setTimeout is going to go haywire and not work as intended?
